...
class KufurKorumasÄ±Modal(discord.ui.Modal, title="KÃ¼fÃ¼r KorumasÄ± AyarlarÄ±"):
...
class SpamModal(discord.ui.Modal, title="Spam Koruma AyarlarÄ±"):
...
class LinkModal(discord.ui.Modal, title="Link Koruma AyarlarÄ±"):
